...
<div class="wrapper col1">
  <div id="header">
    <div class="fl_left">
      <h1><a href="index.html"><i><b><u>E-Gas Sewa</u></b></i></a></h1>
  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
        ...
        <li><a href="Registration.jsp">Login/Sing-Up</a></li>
        <li><a href="faq.jsp">FAQ</a></li>
        <li><a href="#">UseFull-Links</a>
          <ul>
            <li><a href="Registration.jsp">Login/Sing-Up</a></li>
            <li><a href="faq.jsp">FAQ</a></li>
...
<div class="wrapper col6">
  <div id="copyright">
    <p class="fl_left">Copyright &copy; 2014 - All Rights Reserved - <a href="#">AKM Group</a></p>
    <br class="clear" />
  </div>
</div>
</body>
